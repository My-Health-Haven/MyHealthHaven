...
const Footer = () => {
  ...
  const footerCopy =
    language === 'es'
      ? {
          ...
          subSlogan:
            'Ayudamos a pacientes de Estados Unidos a navegar opciones medicas confiables en Mexico.',
  ...
  return (
    <Box
      component='footer'
      sx={{ bgcolor: 'white', py: 6, borderTop: '1px solid', borderColor: 'divider' }}
    >
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            <Stack spacing={1}>
              <MuiLink
                ...
                underline='hover'
              >
                {footerCopy.speakWithNavigator}
              </MuiLink>
              <MuiLink
                href='https://wa.me/12142763928'
                color='text.secondary'
                variant='body2'
                underline='hover'
                target='_blank'
            ...
            <Stack direction='row' spacing={1} sx={{ mt: 2 }}>
              <IconButton
                href='https://www.instagram.com/my.healthhaven?igsh=MTBnZzhlM3ozbWtxeg%3D%3D&utm_source=qr'
                target='_blank'
                rel='noopener noreferrer'
                color='inherit'
              >
              ...
              <IconButton
                href='https://x.com/myhealthhaven1?s=21'
                target='_blank'
                rel='noopener noreferrer'
                color='inherit'
                aria-label='X'
              ...
              <IconButton
                href='https://www.facebook.com/profile.php?id=61586308873245&mibextid=LQQJ4d'
                target='_blank'
                rel='noopener noreferrer'
                color='inherit'
              >
              ...
              <IconButton
                href='https://youtube.com/@my.health.haven1?si=-SiWbDZCe2FhLvl5'
                target='_blank'
                rel='noopener noreferrer'
                color='inherit'
              >
              ...
              <IconButton
                href='https://www.linkedin.com/company/my-health-haven/?viewAsMember=true'
                target='_blank'
                rel='noopener noreferrer'
                color='inherit'
              >
