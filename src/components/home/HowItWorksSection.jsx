...
const HowItWorksSection = React.forwardRef(function HowItWorksSection({ hasMounted }, ref) {
  ...
  return (
    <Box
      id='how-it-works'
      ref={ref}
      sx={{ py: { xs: 8, md: 12 }, bgcolor: 'transparent', position: 'relative' }}
    >
      ...
      <Container
        maxWidth='lg'
        sx={{ px: { xs: 2, md: 6, lg: 10 }, position: 'relative', zIndex: 1 }}
      >
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <FadeIn delay={200}>
                  ...
                  >
                    <Typography
                      variant='h1'
                      className='shiny-text-dark'
                      sx={{ fontWeight: 900, mb: 1, color: 'text.primary', fontSize: '5rem' }}
                    >
