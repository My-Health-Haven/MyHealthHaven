...
export const TravelIllustration = (props) => (
  ...
  >
    ...
    <g transform='rotate(5 32 32)'>
      ...
      <text x='35' y='20' fontSize='4' fill={PALETTE.yellow} textAnchor='middle' fontWeight='bold'>
        PASSPORT
      </text>
    </g>
    {/* Airplane */}
    ...
    <path
      d='M22 34l12 2 6-6 6 2M14 42l7 6'
      stroke={PALETTE.blue}
      strokeWidth='1.5'
      strokeLinecap='round'
    />
...
export const ArrivalIllustration = (props) => (
  ...
  >
    ...
    {/* Map Pin */}
    <path
      d='M32 12c-5.5 0-10 4.5-10 10 0 7.5 10 18 10 18s10-10.5 10-18c0-5.5-4.5-10-10-10z'
      fill={PALETTE.red}
    />
    {/* Person in Pin */}
...
export const HomeIllustration = (props) => (
  ...
  >
    ...
    {/* Shield */}
    <path
      d='M32 14l14 4v12c0 10-14 20-14 20S18 40 18 30V18l14-4z'
      fill={PALETTE.teal}
      opacity='0.2'
    />
    <path
    ...
    {/* Cross */}
    <path
      d='M30 28h4v4h-4zM32 26v8M28 30h8'
